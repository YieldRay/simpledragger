 ...
 */
export function newIframeElement(attrs?: Partial<Record<keyof HTMLIFrameElement, string>>): HTMLIFrameElement {
...
export function postMessageTo(window: Window, message: any, transfer?: Transferable[], targetOrigin?: string): void;
export function postMessageTo(worker: Worker | MessagePort, message: any, transfer?: Transferable[]): void;
